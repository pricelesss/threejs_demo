...
var b5mapp = require('b5m_app');
var b5mappControl = require('b5m_app_control');
	/*!
...
module.exports = (function($, B5MApp,B5MAppControlState, window, document, undefined) {
	var B5MAppControl = new B5MAppControlState();
	var $window = $(window);
	...
	$.fn.lazyload = function(options) {
		...
		var settings = {
			...
			appear: null,
			load: null,
			placeholder: metadata.host+"/htmlImg/placeholder.png"
		};
	...
	return $;
})(zepto, b5mapp,b5mappControl, window, document);
